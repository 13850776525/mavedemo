...
<%--                        </div>--%>
                        <div class="layui-card-body ">
                            ...
                            <script type="text/html" id="checkboxTpl">
                                {{# if (d.docState ==="1"){}}
                                <label  style="color: #ff7800">已审核</label>
                                {{#  } else { }}
                                <label  style="color:dimgrey">未审核</label>
                                {{#}}}
                            </script>
                        </div>
                    </div>
    ...
    <script>
        layui.use(['form','layer','table','util'], function(){
            ...
            table.render({
                ...
                ,url:'${pageContext.request.contextPath}/documentControl/findDocMy'  //数据请求路径
                ,cellMinWidth: 80
                ,cols: [[
                    ...
                    ,{field:'docState', title:'审核', width:'10%',align:'center', templet: '#checkboxTpl', unresize: true}
                ]]
                ,page: true//开启分页
                ,limit:10//默认十条数据一页
