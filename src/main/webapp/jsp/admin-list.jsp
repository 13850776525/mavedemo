    ...
    <script>
        ...
        layui.use(['form','layer','table'], function(){
            ...
            table.render({
                ...
                ,url:'${pageContext.request.contextPath}/adminControl/findAdmin'  //数据请求路径
                ,cellMinWidth: 80
                ,cols: [[
                    {type:'checkbox',width:'10%', title: '选择', sort: true,align:'center'}
                    ,{field:'name', width:'20%', title: '姓名', sort: true,edit:true,align:'center'}
                    ,{field:'account',width:'20%', title: '账号',align:'center'}
                    ,{field:'password',width:'20%', title: '密码', sort: true,edit:true,align:'center'}
                    ,{field:'roleid',width:'10%', title: '角色',edit:true,align:'center'}
            ...
            var $ = layui.$, active = {
                ...
                getCheckData: function(){ //获取选中数据
                    ...
                    layer.confirm('是否删除选中的数据？', function(index){
                        ...
                        var id = {'account':ids}
                        $.ajax({
                            url:$("#path").val()+"/adminControl/deleteManger",
                            method:'post',
                            data:id,
                            dataType:'text',
