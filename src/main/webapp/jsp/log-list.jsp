    ...
    <script>
        ...
        layui.use(['form','layer','table','util'], function(){
            ...
            table.render({
                ...
                ,url:'${pageContext.request.contextPath}/adminControl/findLog'  //数据请求路径
                ,cellMinWidth: 80
                ,cols: [[
                    {type:'checkbox',width:'10%', title: '选择', sort: true,align:'center'}
                    ,{field:'logId', width:'20%', title: '编号', sort: true,edit:true,align:'center'}
                    ,{field:'logUser',width:'20%', title: '操作人',align:'center'}
                    ,{field:'logDate',width:'20%', title: '操作时间', sort: true,edit:true,align:'center', templet: function (d) {
                            return util.toDateString(d.logDate, "yyyy-MM-dd") }
                    }
                    ,{field:'logThing',width:'20%', title: '操作事件',edit:true,align:'center'}
